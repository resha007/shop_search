<%-- 
    ...
    Created on : Apr 10, 2020, 11:07:02 AM
    Author     : resha
--%>

<%@page import="com.shop.service.ShopService"%>
<%@page contentType="text/html" pageEncoding="UTF-8"%>
<%@page import="javax.servlet.http.HttpServletRequest"%>
<%@page import="com.shop.domain.Shop"%>
...
<!--								<li class="social_list_item"><a href="#"><i class="fa fa-twitter" aria-hidden="true"></i></a></li>
						...
						<div class="user_box ml-auto">
							...
							<div class="user_box_register user_box_link"><a href="/user.html">register</a></div>
						</div>
					</div>
				</div>
			</div>		
						...
						<div class="hotel_info">
							...
							<div class="hotel_title_container d-flex flex-lg-row flex-column">
								<div class="hotel_title_content">
									<h1 class="hotel_title"><%= shop.getName() %></h1>
									<div class="rating_r rating_r_4 hotel_rating">
                                                                                (<%= shop.getOtherName() %>)
									</div>
									<div class="hotel_location"><%= shop.getAddress() %></div>
                                                                        <div class="hotel_location"><%= shop.getArea().getName() %> - <%= shop.getArea().getDistrict().getName() %></div>
								</div>
                                                                        <li class="footer_social_item" title="Web Site"><a href="<%= shop.getWebsite() %>"><i class="fa fa-globe"></i></a></li>
								<li class="footer_social_item" title="Facebook Page"><a href="<%= shop.getFbLink() %>"><i class="fa fa-facebook-f"></i></a></li>
								<div class="hotel_title_button ml-lg-auto text-lg-right">
                                                                    <div class="button book_button trans_200" style="pointer-events: none;"><a href=""><%= shop.getCategory().getName() %></a></div>
                                                                        <div class="button book_button trans_200" style="pointer-events: none;"><a href=""><%= status %></a></div>
									<div class="hotel_map_link_container">
                                                                            Contact Number : <div class="hotel_map_link" title="Contact Number"><a href="tel:<%= shop.getContactNo1() %>"><%= shop.getContactNo1() %></a></div> 
                                                                            <div class="hotel_map_link" title="Contact Number"><a href="tel:<%= shop.getContactNo2() %>"><%= shop.getContactNo2() %></a></div><br> 
                                                                            WhatsApp Number : <div class="hotel_map_link" title="WhatsApp Number"><a href="tel:<%= shop.getWhatsappViber() %>"><%= shop.getWhatsappViber() %></a></div>
									</div>
								</div>
							</div>
							...
							<!-- Listing Image -->
                                                        ...
                                                        <%  String brNo = shop.getBrNo();
                                                            String parts[] = null;
                                                            String imgPaths[] =new String[3];
                                                            
                                                            File folder = new File("/opt/apache-tomcat-8.5.53/webapps/ROOT/uploads");
                                                            //File folder = new File("D:\\Java\\Netbeans Projects\\shop_search\\target\\shop_search-1.0-SNAPSHOT\\uploads");
                                                            ...
                                                            for (int i = 0; i < listOfFiles.length; i++) {
                                                                if (listOfFiles[i].isFile()) {
                                                                    ...
                                                                    if(parts[0].equals(brNo)){//System.out.println("########img111 ");
                                                                        imgPaths[a] = fileName;
                                                                        a++;
                                                                    }
                                                                }
							...
							<div class="hotel_image">
                                                            ...
                                                            <img src="../uploads/<%= imgPaths[i] %>" alt="">
                                                            <% } %>
...
<!--                                                            <p style="color:black">Business Registration Number : <b><%= shop.getBrNo() %></b></p>-->
                                                            <p style="color:black">Delivery Time : <b><%= shop.getDeliveryTimeMin() %></b> to <b><%= shop.getDeliveryTimeMax() %></b> hours</p>
                                                            <p style="color:black">Delivery Area : <b><%= shop.getDeliveryKm() %>KM</b></p>
                                                            <% if(!(shop.getEmail().equals("") ||  shop.getEmail().equals(null))) { %>
                                                                <p style="color:black">Email : <b><%= shop.getEmail() %></b></p>
                                                            <% } %>
