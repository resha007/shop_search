...
public class ProvinceServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ProvinceServlet</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ProvinceServlet at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
...
System.out.println("##innnnnnnnnnnnnnnnnnnnnnn"+type);
        if(type.trim().equals("tbl")){
            ...
            list = ProvinceService.getActiveProvinces();
        }
        ...
        System.out.println("##JsonArrayloantype"+jsonString);
    }
